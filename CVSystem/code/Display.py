...
def main():
    ...
    video_file_name = './output_logs/Detected_output_video.mp4'
    csv_file = './output_logs/predicted_touching_fingers.csv'
    ...
    # Output video
    output_video_file = './output_logs/Combined_output_video.mp4'
    fourcc = cv2.VideoWriter_fourcc(*'mp4v')
    out = cv2.VideoWriter(output_video_file, fourcc, fps_input, (frame_width, frame_height))
